...
class BrandProduct extends Controller
{
  ...
  public function all_brand_product() {
    ...
    // $all_brand_product = Brand::paginate(2);
    // $all_brand_product = Brand::orderBy('brand_name', 'desc')->take(3)->get();
    $all_brand_product = Brand::orderBy('brand_name', 'desc')->get();
  ...
  public function update_brand_product(Request $request, $brand_product_id) {
    $this->AuthLogin();
    $data = Brand::find($brand_product_id);
    $data['brand_name'] = $request['brand_product_name'];
    $data['brand_desc'] = $request['brand_product_desc'];
    $data->save();
    // $data = array();
  ...
  public function delete_brand_product($brand_product_id) {
    $this->AuthLogin();
    $data = Brand::find($brand_product_id)->delete();
